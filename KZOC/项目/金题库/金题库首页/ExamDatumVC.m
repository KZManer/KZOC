...
@interface ExamDatumVC ()<UITableViewDataSource,UITableViewDelegate>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation ExamDatumVC
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = Color_Hex(@"EEE8AA");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"考点资料 第%lu个Cell",indexPath.row];
    cell.textLabel.textAlignment = NSTextAlignmentCenter;
    cell.textLabel.textColor = [KTools tools_colorRandom];
    return cell;
}
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString *hintText = [NSString stringWithFormat:@"点击了考点资料的第%lu个Cell",indexPath.row];
