...
@interface ActivityInfoVC ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = Color_Hex(@"FFE7BA");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"活动资讯 第%lu个Cell",indexPath.row];
    cell.textLabel.textAlignment = NSTextAlignmentCenter;
    cell.textLabel.textColor = [KTools tools_colorRandom];
    return cell;
}
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString *hintText = [NSString stringWithFormat:@"点击了活动资讯的第%lu个Cell",indexPath.row];
