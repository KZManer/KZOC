...
@property(retain) NSMutableArray *titles;  //标题
@property(retain) NSMutableArray *data;    //数据
@property(retain) NSMutableArray *columnWidth;  //列宽

@end

@interface DataGridScrollView : UIScrollView
{
	__unsafe_unretained id dataGridComponent;
}
