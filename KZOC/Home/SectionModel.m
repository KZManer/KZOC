...
+ (NSArray *)sectionModels {
    ...
    return @[
        @[
            [self sectionWithName:@"UITableView" className:@"TableViewVC"],
            [self sectionWithName:@"UITableView-高度自适应" className:@"TableViewVC1"],
        ],
        @[
            [self sectionWithName:@"UICollectionView" className:@"CollectionVC"],
        ],
        @[
