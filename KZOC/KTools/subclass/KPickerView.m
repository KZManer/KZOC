...
- (void)doViewUI {
    ...
    _buttonH = 40;
    CGFloat bottomViewH = self.frame.size.height / 3;
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        CGFloat pickerViewHeight = self.bottomView.frame.size.height - 40;
        CGFloat pickerViewY = 40;
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, pickerViewY, self.frame.size.width, pickerViewHeight)];
