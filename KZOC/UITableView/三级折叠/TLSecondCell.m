...
NSString * const CellIdTLSecondCell = @"CellIdTLSecondCell";

@interface TLSecondCell ()
...
- (UIButton *)headBtn {
    if (!_headBtn) {
        ...
        [_headBtn setImage:[UIImage imageNamed:@"tl_second_fold"] forState:UIControlStateNormal];
        [_headBtn setImage:[UIImage imageNamed:@"tl_second_unfold"] forState:UIControlStateSelected];
